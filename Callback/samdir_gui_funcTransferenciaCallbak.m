function samdir_gui_funcTransferenciaCallbak(GUI)
   
    panel = crearPanel_2(GUI.tab(2), GUI);
    drawnow;
    GUI.axTop2 = panel.axTop2;
...
function GUI = crearPanel_2(panel, GUI)
    ...
    axTopPanel_2 = uipanel(panel, 'units','norm', 'pos',[0.01,0.03,0.72,0.93], 'BorderType', 'beveledout',...
            'BorderWidth', 2, 'Background',GUI.ColorFondo*.5);
    GUI.axTop2    = axes('Parent',axTopPanel_2,  'XColor',[1,1,1], 'YColor',[1,1,1], 'pos',[0.08,0.08,0.9,0.85], 'Color',[.3,.3,1], ...
        'Tag','axTop2');
    ...
    boton = uicontrol('Style','pushbutton', 'CData', iconVer,'TooltipString', 'ver','units','norm', ...
            'pos',[0.9 0.08 .043 .06],'parent',axTopPanel_2,'HandleVisibility','callback');
