classdef samdirAudio
    %   Debido a que la clase samdirAudio va a contener los datos en el
    ...
    %   samdirAudio esta variable va a tener un solo valor.
    %   Para hacer referencia a la misma se usa el nombre de la clase + el
    %   operador de acceso: samdirAudio.VALID_SIGNAL_TYPES
    ...
    % Variables definidas en itaSuper    VER
        ...
        timeData            % time domain data in 2D                         VER
    ...
    properties(Dependent = true, Hidden = true)
        ...
        data                %raw data, could be time or frequency domain (CAREFUL!)   VER
    end
    
    
    %%  Los métodos usan por dentro cuatro identificadores respecto a lo 
    %   que son variables de entrada y variables de salida.
	%   varargin significa que es una estructura que contiene parametros 
    %   que se le pasa a la función si son varios para acceder
	%   a los mismos se usa varargin{index}, nargin indica el numero de 
    %   argumentos que la funcion recibió.
	%   varargout significa las variables de salida que va a sacar la 
    %   función y nargout indica el numero de objetos de salida.
	...
	%   97				end
   methods
       function this = samdirAudio(varargin)
       end
